 ...
 * @version: 1.3.12
 * @license: MIT
 * @build: Tue Apr 07 2015 00:37:29 GMT-0400 (Eastern Daylight Time)
 */
...
angular.module("ghiscoding.validation").factory("validationCommon",["$filter","$timeout","$translate","validationRules",function(t,a,e,r){function i(){var t=this,a={};t.validators=[],t.typingLimit=O,t.validatorAttrs.hasOwnProperty("debounce")?t.typingLimit=parseInt(t.validatorAttrs.debounce,10):t.validatorAttrs.hasOwnProperty("typingLimit")&&(t.typingLimit=parseInt(t.validatorAttrs.typingLimit,10));var e=t.validatorAttrs.hasOwnProperty("rules")?t.validatorAttrs.rules:t.validatorAttrs.validation;if(e.indexOf("regex:")>=0){var i=e.match("regex:(.*?):regex");if(i.length<2)throw'Regex validator within the validation needs to be define with an opening "regex:" and a closing ":regex", please review your validator.';var l=i[1].split(":=");a={message:l[0],pattern:l[1]},e=e.replace(i[0],"regex:")}var s=e.split("|");if(s){t.bFieldRequired=e.indexOf("required")>=0?!0:!1;for(var n=0,o=s.length;o>n;n++){var d=s[n].split(":"),u=s[n].indexOf("alt=")>=0?!0:!1;t.validators[n]=r.getElementValidators({altText:u===!0?2===d.length?d[1]:d[2]:"",customRegEx:a,rule:d[0],ruleParams:u&&2===d.length?null:d[1]})}}return t}function l(t){return c(R,"fieldName",t)}function s(){return R}function n(t,a,e,r){this.scope=t,this.elm=a,this.ctrl=r,this.validatorAttrs=e,v(a,e,r),this.defineValidation()}function o(){var t=this;return t.bFieldRequired}function d(t,a){var e=g(t,"field",a);e>=0&&t.splice(e,1)}function u(t,a){var r=a&&a.obj?a.obj:this,i=a&&a.elm?a.elm:r.elm,l=i&&i.attr("name")?i.attr("name"):null;if("undefined"==typeof l||null===l)throw'Angular-Validation Service requires you to have a (name="") attribute on the element to validate... Your element is: ng-model="'+i.attr("ng-model")+'"';var s=a&&a.translate?e(t):t,n=l.replace(/[|&;$%@"<>()+,\[\]\{\}]/g,""),o=null;if(r.validatorAttrs&&r.validatorAttrs.hasOwnProperty("validationErrorTo")){var d=r.validatorAttrs.validationErrorTo.charAt(0),u="."===d||"#"===d?r.validatorAttrs.validationErrorTo:"#"+r.validatorAttrs.validationErrorTo;o=angular.element(document.querySelector(u))}else o=angular.element(document.querySelector(".validation-"+n));var p=a&&a.isSubmitted?a.isSubmitted:!1;a&&!a.isValid&&(p||r.ctrl.$dirty||r.ctrl.$touched)?o.length>0?o.text(s):i.after('<span class="validation validation-'+n+' text-danger">'+s+"</span>"):o.text("")}function p(t,a){for(var r,i=this,s=!0,n=!0,o="",d=0,u=i.validators.length;u>d;d++){if("conditionalDate"===i.validators[d].type){if(r=new RegExp(i.validators[d].pattern,"i"),n="\\S+"!==i.validators[d].pattern||"undefined"!=typeof t&&null!==t?r.test(t):!1){var p=i.validators[d].dateType,v=h(t,p).getTime();if(2==i.validators[d].params.length){var c=h(i.validators[d].params[0],p).getTime(),g=h(i.validators[d].params[1],p).getTime(),f=y(i.validators[d].condition[0],v,c),b=y(i.validators[d].condition[1],v,g);n=f&&b?!0:!1}else{var O=h(i.validators[d].params[0],p).getTime();n=y(i.validators[d].condition,v,O)}}}else if("conditionalNumber"===i.validators[d].type)if(2==i.validators[d].params.length){var f=y(i.validators[d].condition[0],parseFloat(t),parseFloat(i.validators[d].params[0])),b=y(i.validators[d].condition[1],parseFloat(t),parseFloat(i.validators[d].params[1]));n=f&&b?!0:!1}else n=y(i.validators[d].condition,parseFloat(t),parseFloat(i.validators[d].params[0]));else if("match"===i.validators[d].type){var R=i.validators[d].params[0],S=i.scope.$eval(R);n=S===t}else i.elm.prop("disabled")||1==parseInt(i.elm.attr("ng-disabled"))||"true"===i.elm.attr("ng-disabled")?n=!0:"string"==typeof t&&""===t&&"NUMBER"===i.elm.prop("type").toUpperCase()?(o=e("INVALID_KEY_CHAR"),n=!1):(r=new RegExp(i.validators[d].pattern,"i"),n="\\S+"!==i.validators[d].pattern||"undefined"!=typeof t&&null!==t?r.test(t):!1);if((!i.bFieldRequired&&!t||i.elm.prop("disabled")||1==parseInt(i.elm.attr("ng-disabled"))||"true"===i.elm.attr("ng-disabled"))&&(n=!0),!n&&(s=!1,o+=" ",o+=i.validators[d].altText&&i.validators[d].altText.length>0?i.validators[d].altText.replace("alt=",""):e(i.validators[d].message),"undefined"!=typeof i.validators[d].params))for(var E=0,x=i.validators[d].params.length;x>E;E++)"match"===i.validators[d].type&&x>1&&0===E||(o=o.replace(":param",i.validators[d].params[E]))}o=o.trim(),m(i,e(o));var A=l(i.elm.attr("name"));return A&&(A.isValid=n,A.message=e(o)),a&&i.updateErrorMsg(o,{isValid:s}),s}function v(t,a,e){var r={fieldName:t.attr("name"),elm:t,attrs:a,ctrl:e,isValid:!1,message:""},i=g(R,"fieldName",t.attr("name"));return i>=0?R[i]=r:R.push(r),R}function m(t,a){var e=t.elm.attr("name"),r=g(S,"field",e);if(r>=0&&""===a)S.splice(r,1);else if(""!==a){var i={field:e,message:a};r>=0?S[r]=i:S.push(i)}t.scope.$validationSummary=S;var l=f(t);l&&(l.$validationSummary=S)}function c(t,a,e){for(var r=0;r<t.length;r++)if(t[r][a]===e)return t[r];return null}function g(t,a,e){for(var r=0;r<t.length;r++)if(t[r][a]===e)return r;return-1}function f(t){for(var a=document.querySelectorAll("form"),e=0;e<a.length;e++){var r=document.querySelectorAll("form")[e];if(r&&r.name&&t.scope[r.name])return t.scope[r.name]}return null}function h(t,a){var e="",r="-",i=[],l=[],s="",n="",o="";switch(a.toUpperCase()){case"EURO_LONG":case"EURO-LONG":e=t.substring(0,10),r=t.substring(2,3),i=b(e,r),o=i[0],n=i[1],s=i[2],l=t.length>8?t.substring(9).split(":"):null;break;case"UK":case"EURO":case"EURO_SHORT":case"EURO-SHORT":case"EUROPE":e=t.substring(0,8),r=t.substring(2,3),i=b(e,r),o=i[0],n=i[1],s=parseInt(i[2])<50?"20"+i[2]:"19"+i[2],l=t.length>8?t.substring(9).split(":"):null;break;case"US_LONG":case"US-LONG":e=t.substring(0,10),r=t.substring(2,3),i=b(e,r),n=i[0],o=i[1],s=i[2],l=t.length>8?t.substring(9).split(":"):null;break;case"US":case"US_SHORT":case"US-SHORT":e=t.substring(0,8),r=t.substring(2,3),i=b(e,r),n=i[0],o=i[1],s=parseInt(i[2])<50?"20"+i[2]:"19"+i[2],l=t.length>8?t.substring(9).split(":"):null;break;case"ISO":default:e=t.substring(0,10),r=t.substring(4,5),i=b(e,r),s=i[0],n=i[1],o=i[2],l=t.length>10?t.substring(11).split(":"):null}var d=l&&3===l.length?l[0]:0,u=l&&3===l.length?l[1]:0,p=l&&3===l.length?l[2]:0;return new Date(s,n-1,o,d,u,p)}function b(t,a){var e=[];switch(a){case"/":e=t.split("/");break;case".":e=t.split(".");break;case"-":default:e=t.split("-")}return e}function y(t,a,e){var r=!1;switch(t){case"<":r=e>a?!0:!1;break;case"<=":r=e>=a?!0:!1;break;case">":r=a>e?!0:!1;break;case">=":r=a>=e?!0:!1;break;case"!=":case"<>":r=a!=e?!0:!1;break;case"=":case"==":r=a==e?!0:!1;break;default:r=!1}return r}var O=1e3,R=[],S=[],e=t("translate"),E=function(t,a,e,r){this.timer=null,this.bFieldRequired=!1,this.validators=[],this.typingLimit=O,this.scope=t,this.elm=a,this.ctrl=r,this.validatorAttrs=e,t&&a&&e&&r&&(v(a,e,r),this.defineValidation())};return E.prototype.defineValidation=i,E.prototype.getFormElementByName=l,E.prototype.getFormElements=s,E.prototype.isFieldRequired=o,E.prototype.initialize=n,E.prototype.removeFromValidationSummary=d,E.prototype.updateErrorMsg=u,E.prototype.validate=p,E}]);
