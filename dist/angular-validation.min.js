...
angular.module("ghiscoding.validation").service("validationService",["$interpolate","$timeout","validationCommon",function(e,o,t){function a(t,a,i){var n=this,r={};if("string"==typeof t&&"string"==typeof a?(r.elmName=t,r.rules=a,r.friendlyName="string"==typeof i?i:""):r=t,"object"!=typeof r||!r.hasOwnProperty("elmName")||!r.hasOwnProperty("rules")||!r.hasOwnProperty("scope")&&"undefined"==typeof n.validationAttrs.scope)throw"Angular-Validation-Service requires at least the following 3 attributes: {elmName, rules, scope}";var l=r.scope?r.scope:n.validationAttrs.scope;if(r.elm=angular.element(document.querySelector('[name="'+r.elmName+'"]')),"object"!=typeof r.elm||0===r.elm.length)return n;if(new RegExp("{{(.*?)}}").test(r.elmName)&&(r.elmName=e(r.elmName)(l)),r.name=r.elmName,n.validationAttrs.isolatedScope){var m=l.$validationOptions||null;l=n.validationAttrs.isolatedScope,m&&(l.$validationOptions=m)}r.elm.bind("blur",f=function(e){var o=n.commonObj.getFormElementByName(r.elmName);o.isValidationCancelled||(n.commonObj.initialize(l,r.elm,r,r.ctrl),d(n,e.target.value,0))}),r=n.commonObj.mergeObjects(n.validationAttrs,r),p(n,l,r);var c=l.$watch(r.elmName,function(e,t){return void 0===e&&void 0!==t?(o.cancel(n.timer),void n.commonObj.ctrl.$setValidity("validation",n.commonObj.validate("",!0))):(r.ctrl=angular.element(r.elm).controller("ngModel"),r.value=e,n.commonObj.initialize(l,r.elm,r,r.ctrl),void d(n,e))},!0);return v.push({elmName:r.elmName,watcherHandler:c}),n}function i(e){var o=this,t="",a=!0;if("undefined"==typeof e||"undefined"==typeof e.$validationSummary)throw"checkFormValidity() requires a valid Angular Form or $scope object passed as argument to work properly (ex.: $scope.form1  OR  $scope).";for(var i=0,n=e.$validationSummary.length;n>i;i++)if(a=!1,t=e.$validationSummary[i].field){var r=o.commonObj.getFormElementByName(t);r.elm&&r.elm.length>0&&("function"==typeof r.ctrl.$setTouched&&r.ctrl.$setTouched(),o.commonObj.updateErrorMsg(e.$validationSummary[i].message,{isSubmitted:!0,isValid:r.isValid,obj:r}))}return a}function n(e){var o=this;if("undefined"==typeof e||"undefined"==typeof e.$validationSummary)throw"clearInvalidValidatorsInSummary() requires a valid Angular Form or $scope object passed as argument to function properly (ex.: $scope.form1  OR  $scope).";for(var t=[],a=0,i=e.$validationSummary.length;i>a;a++)t.push(e.$validationSummary[a].field);for(a=0,i=t.length;i>a;a++)t[a]&&(o.commonObj.removeFromFormElementObjectList(t[a]),o.commonObj.removeFromValidationSummary(t[a],e.$validationSummary))}function r(e,o){var t,a=this;if("undefined"==typeof e||"undefined"==typeof e.$validationSummary)throw"removeValidator() only works with Validation that were defined by the Service (not by the Directive) and requires a valid Angular Form or $scope object passed as argument to function properly (ex.: $scope.form1  OR  $scope).";if(o instanceof Array)for(var i=0,n=o.length;n>i;i++)t=a.commonObj.getFormElementByName(o[i]),t.elm.removeAttr("validation"),u(a,t,e.$validationSummary);else t=a.commonObj.getFormElementByName(o),t.elm.removeAttr("validation"),u(a,t,e.$validationSummary);return a}function l(e){var o=this,t="boolean"==typeof e?e:!0;o.commonObj.setBypassRootScopeReset(t)}function m(e){var o=this,t="boolean"==typeof e?e:!0;o.commonObj.setDisplayOnlyLastErrorMsg(t)}function c(e){var o=this;return o.validationAttrs=e,o.commonObj.setGlobalOptions(e),o}function d(e,t,a){var i="undefined"!=typeof a?a:e.commonObj.typingLimit,n=e.commonObj.getFormElementByName(e.commonObj.ctrl.$name);return e.commonObj.validate(t,!1),e.commonObj.isFieldRequired()||""!==t&&null!==t&&"undefined"!=typeof t?(n.isValidationCancelled=!1,(e.commonObj.isFieldRequired()||t)&&e.commonObj.ctrl.$setValidity("validation",!1),""!==t&&"undefined"!=typeof t||"NUMBER"!==e.commonObj.elm.prop("type").toUpperCase()?"SELECT"===e.commonObj.elm.prop("tagName").toUpperCase()?(e.commonObj.ctrl.$setValidity("validation",e.commonObj.validate(t,!0)),t):("undefined"!=typeof t&&(e.commonObj.updateErrorMsg(""),o.cancel(e.timer),e.timer=o(function(){e.commonObj.scope.$evalAsync(e.commonObj.ctrl.$setValidity("validation",e.commonObj.validate(t,!0)))},i)),t):(o.cancel(e.timer),e.commonObj.ctrl.$setValidity("validation",e.commonObj.validate(t,!0)),t)):(s(e,n),t)}function s(e,t){var a=t.ctrl?t.ctrl:e.commonObj.ctrl;if(o.cancel(self.timer),t.isValidationCancelled=!0,a.$setValidity("validation",!0),e.commonObj.updateErrorMsg("",{isValid:!0,obj:t}),"function"==typeof f){var i=t.elm?t.elm:e.commonObj.elm;i.unbind("blur",f)}}function u(e,o,t){var a=e.commonObj.scope?e.commonObj.scope:o.scope?o.scope:null;if("undefined"==typeof a)throw"removeValidator() requires a valid $scope object passed but unfortunately could not find it.";var i=e.commonObj.arrayFindObject(v,"elmName",o.fieldName);i&&i.watcherHandler(),o.isValidationCancelled=!0,o.isValid=!0,o.attrs.validation="",s(e,o),"function"==typeof o.ctrl.$setUntouched&&o.ctrl.$setUntouched(),e.commonObj.scope=a,o.ctrl.$setPristine(),e.commonObj.removeFromValidationSummary(o.fieldName,t)}function p(e,t,a){t.$watch(function(){return"undefined"==typeof a.elm.attr("ng-disabled")?null:t.$eval(a.elm.attr("ng-disabled"))},function(i){if("undefined"==typeof i||null===i)return null;a.ctrl=angular.element(a.elm).controller("ngModel"),e.commonObj.initialize(t,a.elm,a,a.ctrl);var n=e.commonObj.getFormElementByName(a.name);o(function(){if(i)a.ctrl.$setValidity("validation",!0),e.commonObj.updateErrorMsg("",{isValid:!0,obj:n}),e.commonObj.removeFromValidationSummary(a.name);else{"function"==typeof a.ctrl.$setTouched&&a.ctrl.$setTouched();var o=a.ctrl.$viewValue||"";e.commonObj.initialize(t,a.elm,a,a.ctrl),a.ctrl.$setValidity("validation",e.commonObj.validate(o,!0))}},0,!1),i&&("function"==typeof a.ctrl.$setUntouched&&a.ctrl.$setUntouched(),a.ctrl.$setValidity("validation",!0),e.commonObj.removeFromValidationSummary(a.name))})}var f,v=[],y=function(){this.isValidationCancelled=!1,this.timer=null,this.validationAttrs={},this.commonObj=new t};return y.prototype.addValidator=a,y.prototype.checkFormValidity=i,y.prototype.removeValidator=r,y.prototype.setBypassRootScopeReset=l,y.prototype.setDisplayOnlyLastErrorMsg=m,y.prototype.setGlobalOptions=c,y.prototype.clearInvalidValidatorsInSummary=n,y}]);