 ...
 * @version: 1.3.18
 * @license: MIT
 * @build: Mon Apr 20 2015 00:37:36 GMT-0400 (Eastern Daylight Time)
 */
angular.module("ghiscoding.validation",["pascalprecht.translate"]).directive("validation",["$timeout","validationCommon","validationRules",function(i,t){return{restrict:"A",require:"ngModel",link:function(a,e,n,d){function l(){i.cancel(r),u.updateErrorMsg(""),d.$setValidity("validation",!0),e.unbind("blur")}function o(t){return u.validate(t,!1),u.isFieldRequired()||""!==t&&null!==t&&"undefined"!=typeof t?((t||u.isFieldRequired())&&d.$setValidity("validation",!1),e.bind("blur",function(){return a.$evalAsync(d.$setValidity("validation",u.validate(t,!0))),t}),""!==t&&"undefined"!=typeof t||"NUMBER"!==e.prop("type").toUpperCase()?"SELECT"===e.prop("tagName").toUpperCase()?(d.$setValidity("validation",u.validate(t,!0)),t):("undefined"!=typeof t&&(u.updateErrorMsg(""),i.cancel(r),r=i(function(){a.$evalAsync(d.$setValidity("validation",u.validate(t,!0)))},u.typingLimit)),t):(i.cancel(r),d.$setValidity("validation",u.validate(t,!0)),t)):(l(),t)}var r,u=new t(a,e,n,d);d.$formatters.unshift(o),d.$parsers.unshift(o),n.$observe("disabled",function(i){i?d.$setValidity("validation",!0):d.$setValidity("validation",u.validate(d.$viewValue,!0))})}}}]);
angular.module("ghiscoding.validation").factory("validationCommon",["$timeout","$translate","validationRules",function(t,e,a){function r(){var t=this,e={};t.validators=[],t.typingLimit=A,t.validatorAttrs.hasOwnProperty("debounce")?t.typingLimit=parseInt(t.validatorAttrs.debounce,10):t.validatorAttrs.hasOwnProperty("typingLimit")?t.typingLimit=parseInt(t.validatorAttrs.typingLimit,10):t.scope.$validationOptions&&t.scope.$validationOptions.hasOwnProperty("debounce")&&(t.typingLimit=parseInt(t.scope.$validationOptions.debounce,10));var r=t.validatorAttrs.hasOwnProperty("rules")?t.validatorAttrs.rules:t.validatorAttrs.validation;if(r.indexOf("regex:")>=0){var i=r.match("regex:(.*?):regex");if(i.length<2)throw'Regex validator within the validation needs to be define with an opening "regex:" and a closing ":regex", please review your validator.';var n=i[1].split(":=");e={message:n[0],pattern:n[1]},r=r.replace(i[0],"regex:")}var s=r.split("|");if(s){t.bFieldRequired=r.indexOf("required")>=0?!0:!1;for(var l=0,o=s.length;o>l;l++){var d=s[l].split(":"),u=s[l].indexOf("alt=")>=0?!0:!1;t.validators[l]=a.getElementValidators({altText:u===!0?2===d.length?d[1]:d[2]:"",customRegEx:e,rule:d[0],ruleParams:u&&2===d.length?null:d[1]})}}return t}function i(t){return g(R,"fieldName",t)}function n(){return R}function s(t,e,a,r){this.scope=t,this.elm=e,this.ctrl=r,this.validatorAttrs=a,m(e,a,r,t),this.defineValidation()}function l(){var t=this;return t.bFieldRequired}function o(t){var e=f(R,"fieldName",t);e>=0&&R.splice(e,1)}function d(t,e){var a=f(t,"field",e);a>=0&&t.splice(a,1),a=f(x,"field",e),a>=0&&x.splice(a,1)}function u(t,a){var r=this;a&&a.obj&&(r=a.obj,r.validatorAttrs=a.obj.attrs);var i=a&&a.elm?a.elm:r.elm,n=i&&i.attr("name")?i.attr("name"):null;if("undefined"==typeof n||null===n)throw'Angular-Validation Service requires you to have a (name="") attribute on the element to validate... Your element is: ng-model="'+i.attr("ng-model")+'"';var s=a&&a.translate?e.instant(t):t,l=n.replace(/[|&;$%@"<>()+,\[\]\{\}]/g,""),o=null;if(r.validatorAttrs&&r.validatorAttrs.hasOwnProperty("validationErrorTo")){var d=r.validatorAttrs.validationErrorTo.charAt(0),u="."===d||"#"===d?r.validatorAttrs.validationErrorTo:"#"+r.validatorAttrs.validationErrorTo;o=angular.element(document.querySelector(u))}o&&0!==o.length||(o=angular.element(document.querySelector(".validation-"+l)));var p=a&&a.isSubmitted?a.isSubmitted:!1;a&&!a.isValid&&(p||r.ctrl.$dirty||r.ctrl.$touched)?o.length>0?o.text(s):i.after('<span class="validation validation-'+l+' text-danger">'+s+"</span>"):o.text("")}function p(t,a){for(var r,n,s=this,l=!0,o=!0,d="",u=s.elm.attr("name"),p=i(u),m=s.validatorAttrs.hasOwnProperty("rules")?s.validatorAttrs.rules:s.validatorAttrs.validation,g=0,v=s.validators.length;v>g;g++){if(n=s.validators[g],"conditionalDate"===n.type){if(r=new RegExp(n.pattern,"i"),l="\\S+"!==n.pattern||"undefined"!=typeof t&&null!==t?r.test(t):!1){var f=n.dateType,h=b(t,f).getTime();if(2==n.params.length){var O=b(n.params[0],f).getTime(),A=b(n.params[1],f).getTime(),R=E(n.condition[0],h,O),S=E(n.condition[1],h,A);l=R&&S?!0:!1}else{var w=b(n.params[0],f).getTime();l=E(n.condition,h,w)}}}else if("conditionalNumber"===n.type)if(2==n.params.length){var R=E(n.condition[0],parseFloat(t),parseFloat(n.params[0])),S=E(n.condition[1],parseFloat(t),parseFloat(n.params[1]));l=R&&S?!0:!1}else l=E(n.condition,parseFloat(t),parseFloat(n.params[0]));else if("match"===n.type){var T=n.params[0],F=s.scope.$eval(T);l=F===t}else s.elm.prop("disabled")||1==parseInt(s.elm.attr("ng-disabled"))||"true"===s.elm.attr("ng-disabled")?l=!0:"string"==typeof t&&""===t&&"NUMBER"===s.elm.prop("type").toUpperCase()?(l=!1,d=e.instant("INVALID_KEY_CHAR")):(r=new RegExp(n.pattern,"i"),l=!("\\S+"===n.pattern||m&&m.indexOf("required")>=0)||"undefined"!=typeof t&&null!==t?r.test(t):!1);(!s.bFieldRequired&&!t||s.elm.prop("disabled")||1==parseInt(s.elm.attr("ng-disabled"))||"true"===s.elm.attr("ng-disabled"))&&(l=!0),l||(o=!1,n.altText&&n.altText.length>0?(d+=" "+n.altText.replace("alt=",""),c(s,d.trim())):!function(t,r,i){e(i.message).then(function(t){d+=" "+y(i,t),d=d.trim(),x=c(p,d),p&&(p.message=d),a&&!p.isValid?s.updateErrorMsg(d,{isValid:o}):p.isValid&&c(p,"")})}(u,l,n))}return l&&(c(s,""),s.updateErrorMsg("",{isValid:l})),p&&(p.isValid=o,o&&(p.message="")),o}function m(t,e,a,r){var i={fieldName:t.attr("name"),elm:t,attrs:e,ctrl:a,scope:r,isValid:!1,message:""},n=f(R,"fieldName",t.attr("name"));return n>=0?R[n]=i:R.push(i),R}function c(t,e){var a=t.elm.attr("name"),r=h(t),i=f(x,"field",a);if(i>=0&&""===e)x.splice(i,1);else if(""!==e){var n={field:a,message:e,formName:r?r.$name:null};i>=0?x[i]=n:x.push(n)}return t.scope.$validationSummary=x,r&&(r.$validationSummary=v(x,"formName",r.$name)),x}function g(t,e,a){for(var r=0;r<t.length;r++)if(t[r][e]===a)return t[r];return null}function v(t,e,a){for(var r=[],i=0;i<t.length;i++)t[i][e]===a&&r.push(t[i]);return r}function f(t,e,a){for(var r=0;r<t.length;r++)if(t[r][e]===a)return r;return-1}function h(t){for(var e=t.elm.attr("name"),a=document.getElementsByName(e),r=0;r<a.length;r++){var i=a[r].form;if(i&&i.name&&t.scope[i.name])return t.scope[i.name]}return null}function b(t,e){var a="",r="-",i=[],n=[],s="",l="",o="";switch(e.toUpperCase()){case"EURO_LONG":case"EURO-LONG":a=t.substring(0,10),r=t.substring(2,3),i=O(a,r),o=i[0],l=i[1],s=i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"UK":case"EURO":case"EURO_SHORT":case"EURO-SHORT":case"EUROPE":a=t.substring(0,8),r=t.substring(2,3),i=O(a,r),o=i[0],l=i[1],s=parseInt(i[2])<50?"20"+i[2]:"19"+i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"US_LONG":case"US-LONG":a=t.substring(0,10),r=t.substring(2,3),i=O(a,r),l=i[0],o=i[1],s=i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"US":case"US_SHORT":case"US-SHORT":a=t.substring(0,8),r=t.substring(2,3),i=O(a,r),l=i[0],o=i[1],s=parseInt(i[2])<50?"20"+i[2]:"19"+i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"ISO":default:a=t.substring(0,10),r=t.substring(4,5),i=O(a,r),s=i[0],l=i[1],o=i[2],n=t.length>10?t.substring(11).split(":"):null}var d=n&&3===n.length?n[0]:0,u=n&&3===n.length?n[1]:0,p=n&&3===n.length?n[2]:0;return new Date(s,l-1,o,d,u,p)}function y(t,e){if(t&&t.params)for(var a=0,r=t.params.length;r>a;a++)"match"===t.type&&r>1&&0===a||(e=e.replace(":param",t.params[a]));return e}function O(t,e){var a=[];switch(e){case"/":a=t.split("/");break;case".":a=t.split(".");break;case"-":default:a=t.split("-")}return a}function E(t,e,a){var r=!1;switch(t){case"<":r=a>e?!0:!1;break;case"<=":r=a>=e?!0:!1;break;case">":r=e>a?!0:!1;break;case">=":r=e>=a?!0:!1;break;case"!=":case"<>":r=e!=a?!0:!1;break;case"=":case"==":r=e==a?!0:!1;break;default:r=!1}return r}var A=1e3,R=[],x=[],S=function(t,e,a,r){this.timer=null,this.bFieldRequired=!1,this.validators=[],this.typingLimit=A,this.scope=t,this.elm=e,this.ctrl=r,this.validatorAttrs=a,t&&e&&a&&r&&(m(e,a,r,t),this.defineValidation())};return S.prototype.defineValidation=r,S.prototype.getFormElementByName=i,S.prototype.getFormElements=n,S.prototype.isFieldRequired=l,S.prototype.initialize=s,S.prototype.updateErrorMsg=u,S.prototype.validate=p,S.prototype.removeFromValidationSummary=d,S.prototype.removeFromFormElementObjectList=o,S}]);
