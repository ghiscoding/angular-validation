 ...
 * @version: 1.3.17
 * @license: MIT
 * @build: Sat Apr 11 2015 17:16:18 GMT-0400 (Eastern Daylight Time)
 */
...
angular.module("ghiscoding.validation").factory("validationCommon",["$q","$timeout","$translate","validationRules",function(t,a,e,r){function i(){var t=this,a={};t.validators=[],t.typingLimit=R,t.validatorAttrs.hasOwnProperty("debounce")?t.typingLimit=parseInt(t.validatorAttrs.debounce,10):t.validatorAttrs.hasOwnProperty("typingLimit")?t.typingLimit=parseInt(t.validatorAttrs.typingLimit,10):t.scope.$validationOptions&&t.scope.$validationOptions.hasOwnProperty("debounce")&&(t.typingLimit=parseInt(t.scope.$validationOptions.debounce,10));var e=t.validatorAttrs.hasOwnProperty("rules")?t.validatorAttrs.rules:t.validatorAttrs.validation;if(e.indexOf("regex:")>=0){var i=e.match("regex:(.*?):regex");if(i.length<2)throw'Regex validator within the validation needs to be define with an opening "regex:" and a closing ":regex", please review your validator.';var n=i[1].split(":=");a={message:n[0],pattern:n[1]},e=e.replace(i[0],"regex:")}var s=e.split("|");if(s){t.bFieldRequired=e.indexOf("required")>=0?!0:!1;for(var l=0,o=s.length;o>l;l++){var d=s[l].split(":"),p=s[l].indexOf("alt=")>=0?!0:!1;t.validators[l]=r.getElementValidators({altText:p===!0?2===d.length?d[1]:d[2]:"",customRegEx:a,rule:d[0],ruleParams:p&&2===d.length?null:d[1]})}}return t}function n(t){return g(x,"fieldName",t)}function s(){return x}function l(t,a,e,r){this.scope=t,this.elm=a,this.ctrl=r,this.validatorAttrs=e,v(a,e,r),this.defineValidation()}function o(){var t=this;return t.bFieldRequired}function d(t,a){var e=h(t,"field",a);e>=0&&t.splice(e,1),e=h(S,"field",a),e>=0&&S.splice(e,1)}function p(t,a){var r=this;a&&a.obj&&(r=a.obj,r.validatorAttrs=a.obj.attrs);var i=a&&a.elm?a.elm:r.elm,n=i&&i.attr("name")?i.attr("name"):null;if("undefined"==typeof n||null===n)throw'Angular-Validation Service requires you to have a (name="") attribute on the element to validate... Your element is: ng-model="'+i.attr("ng-model")+'"';var s=a&&a.translate?e.instant(t):t,l=n.replace(/[|&;$%@"<>()+,\[\]\{\}]/g,""),o=null;if(r.validatorAttrs&&r.validatorAttrs.hasOwnProperty("validationErrorTo")){var d=r.validatorAttrs.validationErrorTo.charAt(0),p="."===d||"#"===d?r.validatorAttrs.validationErrorTo:"#"+r.validatorAttrs.validationErrorTo;o=angular.element(document.querySelector(p))}o&&0!==o.length||(o=angular.element(document.querySelector(".validation-"+l)));var u=a&&a.isSubmitted?a.isSubmitted:!1;a&&!a.isValid&&(u||r.ctrl.$dirty||r.ctrl.$touched)?o.length>0?o.text(s):i.after('<span class="validation validation-'+l+' text-danger">'+s+"</span>"):o.text("")}function u(t,a){for(var r,i=this,s=!0,l=!0,o="",d=0,p=i.validators.length;p>d;d++){if("conditionalDate"===i.validators[d].type){if(r=new RegExp(i.validators[d].pattern,"i"),l="\\S+"!==i.validators[d].pattern||"undefined"!=typeof t&&null!==t?r.test(t):!1){var u=i.validators[d].dateType,v=y(t,u).getTime();if(2==i.validators[d].params.length){var m=y(i.validators[d].params[0],u).getTime(),g=y(i.validators[d].params[1],u).getTime(),f=E(i.validators[d].condition[0],v,m),h=E(i.validators[d].condition[1],v,g);l=f&&h?!0:!1}else{var b=y(i.validators[d].params[0],u).getTime();l=E(i.validators[d].condition,v,b)}}}else if("conditionalNumber"===i.validators[d].type)if(2==i.validators[d].params.length){var f=E(i.validators[d].condition[0],parseFloat(t),parseFloat(i.validators[d].params[0])),h=E(i.validators[d].condition[1],parseFloat(t),parseFloat(i.validators[d].params[1]));l=f&&h?!0:!1}else l=E(i.validators[d].condition,parseFloat(t),parseFloat(i.validators[d].params[0]));else if("match"===i.validators[d].type){var O=i.validators[d].params[0],R=i.scope.$eval(O);l=R===t}else i.elm.prop("disabled")||1==parseInt(i.elm.attr("ng-disabled"))||"true"===i.elm.attr("ng-disabled")?l=!0:"string"==typeof t&&""===t&&"NUMBER"===i.elm.prop("type").toUpperCase()?(o=e.instant("INVALID_KEY_CHAR"),l=!1):(r=new RegExp(i.validators[d].pattern,"i"),l="\\S+"!==i.validators[d].pattern||"undefined"!=typeof t&&null!==t?r.test(t):!1);if((!i.bFieldRequired&&!t||i.elm.prop("disabled")||1==parseInt(i.elm.attr("ng-disabled"))||"true"===i.elm.attr("ng-disabled"))&&(l=!0),!l&&(s=!1,o+=" ",o+=i.validators[d].altText&&i.validators[d].altText.length>0?i.validators[d].altText.replace("alt=",""):e.instant(i.validators[d].message),"undefined"!=typeof i.validators[d].params))for(var x=0,S=i.validators[d].params.length;S>x;x++)"match"===i.validators[d].type&&S>1&&0===x||(o=o.replace(":param",i.validators[d].params[x]))}o=o.trim(),c(i,e.instant(o));var A=n(i.elm.attr("name"));return A&&(A.isValid=l,A.message=e.instant(o)),a&&i.updateErrorMsg(o,{isValid:s}),s}function v(t,a,e){var r={fieldName:t.attr("name"),elm:t,attrs:a,ctrl:e,isValid:!1,message:""},i=h(x,"fieldName",t.attr("name"));return i>=0?x[i]=r:x.push(r),x}function m(t){var a=h(x,"fieldName",t);a>=0&&x.splice(a,1)}function c(t,a){var e=t.elm.attr("name"),r=b(t),i=h(S,"field",e);if(i>=0&&""===a)S.splice(i,1);else if(""!==a){var n={field:e,message:a,formName:r?r.$name:null};i>=0?S[i]=n:S.push(n)}t.scope.$validationSummary=S,r&&(r.$validationSummary=f(S,"formName",r.$name))}function g(t,a,e){for(var r=0;r<t.length;r++)if(t[r][a]===e)return t[r];return null}function f(t,a,e){for(var r=[],i=0;i<t.length;i++)t[i][a]===e&&r.push(t[i]);return r}function h(t,a,e){for(var r=0;r<t.length;r++)if(t[r][a]===e)return r;return-1}function b(t){for(var a=t.elm.attr("name"),e=document.getElementsByName(a),r=0;r<e.length;r++){var i=e[r].form;if(i&&i.name&&t.scope[i.name])return t.scope[i.name]}return null}function y(t,a){var e="",r="-",i=[],n=[],s="",l="",o="";switch(a.toUpperCase()){case"EURO_LONG":case"EURO-LONG":e=t.substring(0,10),r=t.substring(2,3),i=O(e,r),o=i[0],l=i[1],s=i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"UK":case"EURO":case"EURO_SHORT":case"EURO-SHORT":case"EUROPE":e=t.substring(0,8),r=t.substring(2,3),i=O(e,r),o=i[0],l=i[1],s=parseInt(i[2])<50?"20"+i[2]:"19"+i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"US_LONG":case"US-LONG":e=t.substring(0,10),r=t.substring(2,3),i=O(e,r),l=i[0],o=i[1],s=i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"US":case"US_SHORT":case"US-SHORT":e=t.substring(0,8),r=t.substring(2,3),i=O(e,r),l=i[0],o=i[1],s=parseInt(i[2])<50?"20"+i[2]:"19"+i[2],n=t.length>8?t.substring(9).split(":"):null;break;case"ISO":default:e=t.substring(0,10),r=t.substring(4,5),i=O(e,r),s=i[0],l=i[1],o=i[2],n=t.length>10?t.substring(11).split(":"):null}var d=n&&3===n.length?n[0]:0,p=n&&3===n.length?n[1]:0,u=n&&3===n.length?n[2]:0;return new Date(s,l-1,o,d,p,u)}function O(t,a){var e=[];switch(a){case"/":e=t.split("/");break;case".":e=t.split(".");break;case"-":default:e=t.split("-")}return e}function E(t,a,e){var r=!1;switch(t){case"<":r=e>a?!0:!1;break;case"<=":r=e>=a?!0:!1;break;case">":r=a>e?!0:!1;break;case">=":r=a>=e?!0:!1;break;case"!=":case"<>":r=a!=e?!0:!1;break;case"=":case"==":r=a==e?!0:!1;break;default:r=!1}return r}var R=1e3,x=[],S=[],A=function(t,a,e,r){this.timer=null,this.bFieldRequired=!1,this.validators=[],this.typingLimit=R,this.scope=t,this.elm=a,this.ctrl=r,this.validatorAttrs=e,t&&a&&e&&r&&(v(a,e,r),this.defineValidation())};return A.prototype.defineValidation=i,A.prototype.getFormElementByName=n,A.prototype.getFormElements=s,A.prototype.isFieldRequired=o,A.prototype.initialize=l,A.prototype.removeFromValidationSummary=d,A.prototype.updateErrorMsg=p,A.prototype.validate=u,A.prototype.removeFromFormElementObjectList=m,A}]);
